...
The CSIP intends to engage Climate Smart Agriculture (CSA) practitioners and decision makers in developing programmatic and investment strategies that integrate conflict-sensitive approaches in CSA interventions. To achieve this targeted areas have been identified based on evidence from an intersection of climate and conflict. Three scenarios, focusing on only high conflict wiith different climate hotspot categories, were analyzed as follows:

1. **Scenario I**

In this scenario all available ACCLED conflict data between 1997--2022 were used. 
...
In this scenario all available ACCLED conflict data between 2012--2022 were used. 
