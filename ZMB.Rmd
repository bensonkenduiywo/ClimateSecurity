...
conf$Province <- conf$NAME_1
conf$District <- conf$NAME_2
...
ken <- tm_shape(bdy1, name = 'Province')+
  ...
  tm_fill(col= "clust", palette="-YlOrRd", title = 'Climate-Conflict-Hotspots', labels=labs, popup.vars=c("Province","District", "Fatalities", "climvar_medn_prec", "climvar_NDWS_median"))+
